...
if __name__ == "__main__":
    ...
    # Skipping mask saving - just printing path for consistency/logs
    print("Masks were processed but not saved.")
    
    # Optionally still show how long the image processing might have taken (mocked)
    t0 = time.time()
    # Simulate the time it might take to save if needed (can be removed if not desired)
    t1 = time.time()
