...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for idx, input in enumerate(test_loader):
            ...
            # Check number of returned items and unpack accordingly
            if len(input) == 3:
                images, _, img_ids = input  # ignore masks
            elif len(input) == 2:
                images, img_ids = input     # mask-free version
            else:
    ...
    print("Done — saved masks for first 5 images.")
